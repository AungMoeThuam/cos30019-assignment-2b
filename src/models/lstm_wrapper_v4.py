...
class LSTMRegressorWrapperV4:
    def __init__(
        self,
        model_path="models_saved/lstm_model_v4.keras",
        metadata_path="models_saved/lstm_metadata_v4.joblib",
        ...
        if not os.path.exists(model_path):
            raise FileNotFoundError(f"LSTM v4 model not found at {model_path}.")
